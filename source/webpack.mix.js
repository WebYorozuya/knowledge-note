...
mix.ts('resources/js/app.js', 'public/js')
    ...
    .ts('resources/js/typescript/btn_ranking.ts', 'public/js')
    .ts('resources/js/typescript/change_rank_design.ts', 'public/js')
    ...
    .sass('resources/sass/pages/linklist-page.scss', 'public/css')
    .sass('resources/sass/pages/register-page.scss', 'public/css')
    .sass('resources/sass/pages/contact-page.scss', 'public/css')
    .sass('resources/sass/pages/setting-page.scss', 'public/css')
